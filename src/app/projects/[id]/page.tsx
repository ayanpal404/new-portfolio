...
export default function ProjectPage({ params }: PageProps) {
  ...
  const getProjectImage = () => {
    ...
    return project?.title && project.title.length % 2 === 0
      ? "/project1.png"
      : "/project2.png";
  };
  ...
  if (!project) {
    return (
      <div className="max-w-2xl mx-auto px-6 py-8 text-center">
        <button onClick={() => window.history.back()} className="font-semibold text-lg mb-2">
          ← Back
        </button>
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-8 space-y-4 pb-32">
      ...
      <p className="text-sm text-gray-700 dark:text-gray-300">
        Deployed via: <strong>Vercel</strong> | CI/CD: <strong>GitHub Actions</strong>
      </p>
